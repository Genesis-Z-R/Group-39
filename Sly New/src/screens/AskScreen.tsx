    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        <View style={[styles.header, { backgroundColor: theme.colors.surface, borderBottomColor: theme.colors.border }]}>
          ...
          <View style={styles.headerText}>
            <Text style={[styles.title, { color: theme.colors.text }]}>Ask a Question</Text>
        ...
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: theme.colors.text }]}>Question Title *</Text>
            <TextInput
              ...
              blurOnSubmit={false}
            />
            <Text style={[styles.characterCount, { color: theme.colors.textSecondary }]}>{title.length}/300</Text>
          </View>

          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: theme.colors.text }]}>Question Details *</Text>
            <TextInput
              ...
              blurOnSubmit={false}
            />
            <Text style={[styles.characterCount, { color: theme.colors.textSecondary }]}>{content.length}/5000</Text>
          </View>

          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: theme.colors.text }]}>Tags *</Text>
            <Text style={[styles.tagDescription, { color: theme.colors.textSecondary }]}>
            ...
            <View style={styles.tagInputContainer}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  !currentTag.trim() && { backgroundColor: theme.colors.border }
                ]}
          ...
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { color: theme.colors.text }]}>Add Images (Optional)</Text>
            <TouchableOpacity
              style={[styles.imageUploadButton, { backgroundColor: theme.colors.border }]}
              onPress={async () => {
            ...
            >
              ...
              <Text style={[styles.imageUploadButtonText, { color: theme.colors.primary }]}>
      ...
      <View style={[styles.footer, { backgroundColor: theme.colors.surface, borderTopColor: theme.colors.border }]}>
        <View style={styles.footerButtons}>
          ...
          >
            <Text style={[styles.draftButtonText, { color: theme.colors.warning }]}>Save Draft</Text>
          </TouchableOpacity>
        </View>
