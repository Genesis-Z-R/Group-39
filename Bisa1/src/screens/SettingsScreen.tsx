      ...
      items: [
        {
          ...
          onPress: () => Alert.alert('Help Center', 'Navigate to help center'),
        },
        {
          id: 'contact-support',
          ...
          onPress: () => Alert.alert('Contact Support', 'Navigate to contact support'),
        },
        {
          id: 'report-bug',
          title: 'Report a Bug',
          ...
          type: 'navigate' as const,
          icon: 'bug-outline',
          onPress: () => Alert.alert('Report Bug', 'Navigate to bug report form'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          onPress: () => Alert.alert('About BISA', 'Navigate to about page'),
        },
        {
          id: 'terms-of-service',
          ...
          onPress: () => Alert.alert('Terms of Service', 'Navigate to terms page'),
        },
        {
          id: 'privacy-policy',
